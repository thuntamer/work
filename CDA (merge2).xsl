...
<xsl:stylesheet version="1.0"
        ...
        <div style="margin-left: {$margin}em;" class="section">
            ...
            <div class="section-content">
                ...
                <div class="section-body">
                    ...
                    <xsl:choose>
            <!-- 2.A Lab Orders & Results section  (code 30954-2) -->
            <xsl:when test="hl7:code/@code = '30954-2'">
                <xsl:call-template name="renderLabOrdersOrdered"/>
                <xsl:call-template name="renderLabResults"/>
            </xsl:when>
            ...
            <xsl:when test="hl7:code/@code = '46240-8' or self::hl7:section[not(hl7:code) and ancestor::hl7:encompassingEncounter]">
                <xsl:call-template name="renderEncounters"/>
            </xsl:when>

            <!-- 2.D Problems / Diagnoses (code 11450-4) -->
            <xsl:when test="hl7:code/@code = '11450-4'">
                <xsl:call-template name="renderProblems"/>
            </xsl:when>
        </xsl:choose>
                </div>
            </div>
            ...
            <table class="header_table">
                <tbody>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="td_label td_label_width">First Name</td>
                            <td>
                                <xsl:value-of select="hl7:patient/hl7:name/hl7:given[1]"/>
                                <xsl:if test="not(hl7:patient/hl7:name/hl7:given)">
                                    <xsl:text>&#8212;</xsl:text>
                                </xsl:if>
                            </td>
                            <td class="td_label td_label_width">Last Name</td>
                            <td>
                                <xsl:value-of select="hl7:patient/hl7:name/hl7:family[1]"/>
                                <xsl:if test="not(hl7:patient/hl7:name/hl7:family)">
                                    <xsl:text>&#8212;</xsl:text>
                                </xsl:if>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="td_label td_label_width">Street Address</td>
                            <td>
                                <xsl:call-template name="show-address-set">
                            ...
                            <td class="td_label td_label_width">City</td>
                            <td>
                                <xsl:value-of select="hl7:addr/hl7:city"/>
                                <xsl:if test="not(hl7:addr/hl7:city)">
                                    <xsl:text>&#8212;</xsl:text>
                                </xsl:if>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="td_label td_label_width">State</td>
                            <td>
                                <xsl:value-of select="hl7:addr/hl7:state"/>
                                <xsl:if test="not(hl7:addr/hl7:state)">
                                    <xsl:text>&#8212;</xsl:text>
                                </xsl:if>
                            </td>
                            <td class="td_label td_label_width">Postal Code</td>
                            <td>
                                <xsl:value-of select="hl7:addr/hl7:postalCode"/>
                                <xsl:if test="not(hl7:addr/hl7:postalCode)">
                                    <xsl:text>&#8212;</xsl:text>
                                </xsl:if>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="td_label td_label_width">Date of Birth</td>
                            <td>
                                <xsl:call-template name="show-timestamp">
                                    <xsl:with-param name="in" select="hl7:patient/hl7:birthTime"/>
                                </xsl:call-template>
                                <xsl:if test="not(hl7:patient/hl7:birthTime)">
                                    <xsl:text>&#8212;</xsl:text>
                                </xsl:if>
                            </td>
                            <td class="td_label td_label_width">Administrative Sex</td>
                            <td>
                                <xsl:value-of select="hl7:patient/hl7:administrativeGenderCode/@displayName"/>
                                <xsl:if test="not(hl7:patient/hl7:administrativeGenderCode)">
                                    <xsl:text>&#8212;</xsl:text>
                                </xsl:if>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="td_label td_label_width">Gender Identity</td>
                            <td>
                                <xsl:value-of select="hl7:patient/sdtc:genderIdentityCode/@displayName"/>
                                <xsl:if test="not(hl7:patient/sdtc:genderIdentityCode)">
                                    <xsl:text>&#8212;</xsl:text>
                                </xsl:if>
                            </td>
                            <td class="td_label td_label_width">Pregnancy Status</td>
                            <td>
                                <xsl:value-of select="ancestor::hl7:ClinicalDocument//hl7:observation[hl7:code/@code='82810-3']/hl7:value/@displayName"/>
                                <xsl:if test="not(ancestor::hl7:ClinicalDocument//hl7:observation[hl7:code/@code='82810-3'])">
                                    <xsl:text>&#8212;</xsl:text>
                                </xsl:if>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="td_label td_label_width">Race</td>
                            <td>
                                <xsl:value-of select="hl7:patient/hl7:raceCode/@displayName"/>
                                <xsl:if test="not(hl7:patient/hl7:raceCode)">
                                    <xsl:text>&#8212;</xsl:text>
                                </xsl:if>
                            </td>
                            <td class="td_label td_label_width">Ethnicity</td>
                            <td>
                                <xsl:value-of select="hl7:patient/hl7:ethnicGroupCode/@displayName"/>
                                <xsl:if test="not(hl7:patient/hl7:ethnicGroupCode)">
                                    <xsl:text>&#8212;</xsl:text>
                                </xsl:if>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="td_label td_label_width">Preferred Language</td>
                            <td colspan="3">
                                <xsl:value-of select="hl7:patient/hl7:languageCommunication/hl7:languageCode/@code"/>
    ...
    <!-- ========== 2. BODY – repeating content wrappers ========================= -->

    <!-- 2A – Lab Orders (ordered) -->
    <xsl:template name="renderLabOrdersOrdered">
        <xsl:variable name="rows" select="//hl7:section[hl7:code/@code='30954-2']//hl7:entry/hl7:observationRequest[not(@nullFlavor)]"/>
        <xsl:if test="$rows">
                ...
                <tbody>
                    <xsl:for-each select="$rows">
                        <tr class="narr_tr">
                            ...
                            <td>
                                <xsl:value-of select="hl7:id[@root][1]/@extension"/>
                            </td>
                            <td>
                                <xsl:call-template name="show-timestamp">
                                    <xsl:with-param name="in" select="hl7:effectiveTime"/>
                            ...
                            <td>
                                <xsl:call-template name="show-name-set">
                                    <xsl:with-param name="in" select="hl7:author/hl7:assignedAuthor/hl7:assignedPerson/hl7:name"/>
                                </xsl:call-template>
                            </td>
                        </tr>
                    </xsl:for-each>
    ...
    <!-- 2B – Lab Results (resulted) -->
    <xsl:template name="renderLabResults">
        <xsl:variable name="rows" select="//hl7:section[hl7:code/@code='30954-2']//hl7:entry/hl7:observation[not(@nullFlavor)]"/>
        <xsl:if test="$rows">
            <table class="narr_table">
                <thead>
                    <tr class="narr_th">
                ...
                <tbody>
                    <xsl:for-each select="$rows">
                        <tr class="narr_tr">
                            ...
                            <td>
                                <xsl:call-template name="show-name-set">
                                    <xsl:with-param name="in" select="hl7:participant/hl7:participantRole/hl7:playingEntity/hl7:name"/>
                                </xsl:call-template>
                            </td>
                        </tr>
                    </xsl:for-each>
    ...
    <!-- 2C – Medication Administrations -->
    <xsl:template name="renderMedicationAdmin">
        <xsl:variable name="rows" select="//hl7:section[hl7:code/@code='29549-3']//hl7:entry/hl7:substanceAdministration[not(@nullFlavor)]"/>
        <xsl:if test="$rows">
            <table class="narr_table">
                <thead>
                    <tr class="narr_th">
    ...
    <!-- 2D – Encounters (visits) -->
    <xsl:template name="renderEncounters">
        <xsl:variable name="rows" select="//hl7:section[hl7:code/@code='46240-8']//hl7:entry/hl7:encounter[not(@nullFlavor)]"/>
        <xsl:if test="$rows">
            <table class="narr_table">
                <thead>
                    <tr class="narr_th">
                ...
                <tbody>
                    <xsl:for-each select="$rows">
                        <tr class="narr_tr">
                            ...
                            <td>
                                <xsl:call-template name="show-name-set">
                                    <xsl:with-param name="in" select="hl7:responsibleParty/hl7:assignedEntity/hl7:assignedPerson/hl7:name"/>
                                </xsl:call-template>
                            </td>
                        </tr>
                    </xsl:for-each>
    ...
    <!-- 2E – Problems / Diagnoses -->
    <xsl:template name="renderProblems">
        <xsl:variable name="rows" select="//hl7:section[hl7:code/@code='11450-4']//hl7:entry/hl7:observation[not(@nullFlavor)]"/>
        <xsl:if test="$rows">
            <table class="narr_table">
                <thead>
                    <tr class="narr_th">
